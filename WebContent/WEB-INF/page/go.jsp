...
<head>
    ...
    $(function(){
    	...
    	$.ajax({
    		url:'/yue/getPersonConnSuccess.html?id='+userId+'&status=2',
    		type:'GET',
    		dataType:'JSON',
    		    ...
    		    if(res.data!=null&&res.data.length>0){
    		    	for(var i = 0;i<res.data.length;i++){
    		    		...
    		    		if(userId==res.data[i].first){
    		    			...
    		    			res.data[i].pic = '/yue/themes/data/'+res.data[i].likeUser.pic1;
    		    		}else{
    		    			...
    		    			res.data[i].pic = '/yue/themes/data/'+res.data[i].user.pic1;
    		    		}	
    ...
    function doGo(userId,id){
    	...
    	if(seeStatus!=null&&seeStatus!=''&&seeStatus==1){
    		var url = '/yue/person.html?userId='+userId+'&id='+id+'&statusA=1';
    		location.href = url;
    	}else{
    		var url = '/yue/person.html?userId='+userId+'&id='+id+'&statusA=1';
...
<body>
	...
	<header>
       <a href="javascript:;" class="menu-btn"><img src="/yue/themes/img/321.png"/></a>
        <span class="center">约会列表</span>
         <a href="/yue/select.html?userId=${userId }" class="right"><img src="/yue/themes/img/home.png" /></a>
    </header>
   ...
   <nav class="menu">
    <div class="menu-logo">
        <img src="/themes/data/${sessionScope.pic}" onclick="javascript:location.href='/yue/person.html?id=${userId}&userId=${userId }';"/>
        <p>${sessionScope.name}</p>
	     ...
	     <ul>
	    	...
	    	<li><a href="javascript:location.href='/yue/select.html?userId=${userId }&id=${userId }';"><img src="/yue/themes/img/home.png"/>返回筛选</a></li>
	    </ul>
	</nav>
     </div>
     <div class="g-dialog-contianer" id="noDiv" style="display: none;" >
        <div class="dialog-window ">
            ...
            <div class="dialog-footer">
                <a class="green" href="/yue/select.html?userId=${userId }">去寻找我的心仪对象</a>
            </div>
        </div>
    </div>
