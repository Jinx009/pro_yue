...
<head>
    ...
    $(function(){
    	...
    	$.ajax({
    		url:'/yue/getPersonConnSuccess.html?id='+userId+'&status=1',
    		type:'GET',
    		dataType:'JSON',
...
<body>
    ...
    <div class="love-list"  >
        <div class="love-list-col" v-for="model in items" onclick="javascript:location.href='/yue/person.html?userId={{model.userId}}&id={{model.xx}}';"  >
