...
<head>
    ...
    $(function(){
    	...
    	$.ajax({
    		url:'<%=request.getContextPath() %>/getPersonConnSuccess.html?id='+userId+'&status=1',
    		type:'GET',
    		dataType:'JSON',
...
<body>
    ...
    <div class="love-list"  >
        <div class="love-list-col" v-for="model in items" onclick="javascript:location.href='/person.html?userId={{model.userId}}&id={{model.xx}}';"  >
          ...
          <nav class="menu">
    <div class="menu-logo">
        <img src="<%=request.getContextPath() %>/themes/data/${sessionScope.pic}" onclick="javascript:location.href='/person.html?id=${userId}&userId=${userId }';"/>
