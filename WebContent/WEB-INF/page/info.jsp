...
<head>
    ...
    <script type="text/javascript">
         ...
         */
         ...
         imgArray[0] = {localId : [], serverId : [],restId : null};
         imgArray[1] = {localId : [], serverId : [],restId : null};
         imgArray[2] = {localId : [], serverId : [],restId : null};
        ...
        function sendData(){
        	...
        	/* }else if($('#danwei').val()==null&&$('#danwei').val()==''){
            	...
            	var params = 'realName='+$('#realName').val()+'&sex='+$('#sexText input[name="searcher"]:checked ').val()+
            				 '&num='+$('#num').val()+'&age='+$('#age').val()+'&address='+$('#address').val()+
            				 '&job='+$('#job').val()+'&likes='+$('#likes').val()+'&request='+$('#request').val()+
            				 '&zodiac='+$('#zodiac').text()+'&edu='+$('#edu').text()+'&tag='+$('#tag').val()+
            				 '&info='+$('#info').val()+'&pic1='+imgArray[0].restId+'&pic2='+imgArray[1].restId+
            				 '&pic3='+imgArray[2].restId+'&userId='+$('#userId').val()+'&mobilePhone='+$('#mobilePhone').val()+'&wechatAccount='+$('#wechatAccount').val()+
            				 '&danwei='+$('#danwei').val();
...
<body>
 ...
 <!--    <div class="ID-col"></div> -->
    <div class="ID-list">
        ...
        <div class="ID-col ID-col-three">
            <p class="left"><b>*</b><span>性别</span></p>
            <div class="right" id="sexText" >
                <label class="one_radio-button">
                    <input type="radio" name="searcher" id="male" value="男" checked>
                    <div class="one_radio-button__checkmark"></div>
                    <span>男</span>
                </label>
                <label class="one_radio-button">
                    <input type="radio" name="searcher" id="female" value="女">
                    <div class="one_radio-button__checkmark"></div>
                    <span>女</span>
                </label>
            </div>
