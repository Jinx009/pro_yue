var womanApp = angular.module('womanApp', []);
womanApp.controller('womanController', function($http,$scope) {
	 $http.get('/data/articleContent/type.html?typeId=6').success(function(res){
		 if(null!=res.data){
