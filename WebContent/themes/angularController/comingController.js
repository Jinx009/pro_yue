var comingApp = angular.module('comingApp', []);
comingApp.controller('comingController', function($http,$scope) {
	 $http.get('/data/articleContent/type.html?typeId=1').success(function(res){
		 if(null!=res.data){
